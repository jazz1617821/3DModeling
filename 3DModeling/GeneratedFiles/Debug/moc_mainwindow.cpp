...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MainWindow::*_t)(vmodel_t * );
        ...
        {
            typedef void (MainWindow::*_t)(vdata_t * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::sentVDataPtr)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MainWindow::sentVModelPtr(vmodel_t * _t1)
{
...
// SIGNAL 1
void MainWindow::sentVDataPtr(vdata_t * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
