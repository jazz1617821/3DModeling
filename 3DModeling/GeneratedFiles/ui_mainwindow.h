...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        x_axis_viewwidget = new QOpenGLWidget(editWidgetLayout);
        ...
        z_axis_viewwidget = new QOpenGLWidget(editWidgetLayout);
