...
ThreeDimesion_ViewWidget::ThreeDimesion_ViewWidget(QWidget * parent) : QOpenGLWidget(parent)
{
	setupOpenGL();
...
void ThreeDimesion_ViewWidget::genSSAO(void)
{
	// Set samplers
...
void ThreeDimesion_ViewWidget::genShadowMapping(void)
{
...
void ThreeDimesion_ViewWidget::genMultiSampling(void)
{
...
void ThreeDimesion_ViewWidget::setupOpenGL(void)
{
...
void ThreeDimesion_ViewWidget::initializeGL(void)
{
	float mat[16];
...
void ThreeDimesion_ViewWidget::configureShadowMapping(void)
{
...
void ThreeDimesion_ViewWidget::configureGBufferShader(void)
{

}

void ThreeDimesion_ViewWidget::renderScene(void)
{
	int i;
...
void ThreeDimesion_ViewWidget::renderBbox(void)
{
	int i;
...
void ThreeDimesion_ViewWidget::setViewingMatrix(void)
{
...
void ThreeDimesion_ViewWidget::setLighting(void)
{
	GLuint loc;
...
void ThreeDimesion_ViewWidget::setMaterial(vbo_t obj)
{
	GLuint loc;
...
void ThreeDimesion_ViewWidget::fixView(void)
{
	float temp;
...
void ThreeDimesion_ViewWidget::updateViewing(void)
{
	float mat[16];
...
void ThreeDimesion_ViewWidget::bindData(vbo_t* vbo)
{
	int i;
...
void ThreeDimesion_ViewWidget::drawData(vbo_t* const vbo, int mode)
{
	int i;
	float rotMat[16];
...
void ThreeDimesion_ViewWidget::drawBbox(vbo_t* const vbo, int mode)
{
	int i;
...
void ThreeDimesion_ViewWidget::gBufferRendering(void)
{
	glBindFramebuffer(GL_FRAMEBUFFER, gBuffer);
...
void ThreeDimesion_ViewWidget::ssaoTextureRendering(void)
{
	glBindFramebuffer(GL_FRAMEBUFFER, ssaoFBO);
...
void ThreeDimesion_ViewWidget::ssaoBlurRendering(void)
{
...
void ThreeDimesion_ViewWidget::ssaoLightPassRendering(void)
{
...
void ThreeDimesion_ViewWidget::shadowMappingRendering(void)
{
...
void ThreeDimesion_ViewWidget::paintGL(void)
{
...
void ThreeDimesion_ViewWidget::resizeSSAO(void)
{
	glBindFramebuffer(GL_FRAMEBUFFER, gBuffer);
	// - Position + linear depth color buffer
	glBindTexture(GL_TEXTURE_2D, gPositionDepth);
...
void ThreeDimesion_ViewWidget::resizeGL(int width, int height)
{
	float mat[16];
...
void ThreeDimesion_ViewWidget::mousePressEvent(QMouseEvent *e)
{
	int i, ret;
	unsigned int objID;
	float rayDir[3];
...
void ThreeDimesion_ViewWidget::mouseMoveEvent(QMouseEvent *e)
{
...
void ThreeDimesion_ViewWidget::mouseReleaseEvent(QMouseEvent *e)
{

}

void ThreeDimesion_ViewWidget::keyPressEvent(QKeyEvent *e)
{
	int key;
...
void ThreeDimesion_ViewWidget::wheelEvent(QWheelEvent *e)
{
...
void ThreeDimesion_ViewWidget::renderQuad()
{
	if (quadVAO == 0)
	{
...
/*
void ThreeDimesion_ViewWidget::openVO(const char* fileName)
{
int i;
voxelobj_t* obj;
...
void ThreeDimesion_ViewWidget::openVolume(const char* fileName)
{
