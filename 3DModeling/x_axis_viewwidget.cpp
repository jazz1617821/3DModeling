...
X_Axis_ViewWidget::X_Axis_ViewWidget(QWidget * parent) : QOpenGLWidget(parent)
{
	setupOpenGL();
...
void X_Axis_ViewWidget::genSSAO(void)
{
	// Set samplers
...
void X_Axis_ViewWidget::genShadowMapping(void)
{
...
void X_Axis_ViewWidget::genMultiSampling(void)
{
...
void X_Axis_ViewWidget::setupOpenGL(void)
{
...
void X_Axis_ViewWidget::initializeGL(void)
{
	float mat[16];
...
void X_Axis_ViewWidget::configureShadowMapping(void)
{
...
void X_Axis_ViewWidget::configureGBufferShader(void)
{

}

void X_Axis_ViewWidget::renderScene(void)
{
	int i;
...
void X_Axis_ViewWidget::renderBbox(void)
{
	int i;
...
void X_Axis_ViewWidget::setViewingMatrix(void)
{
...
void X_Axis_ViewWidget::setLighting(void)
{
	GLuint loc;
...
void X_Axis_ViewWidget::setMaterial(vbo_t obj)
{
	GLuint loc;
...
void X_Axis_ViewWidget::updateViewing(void)
{
	float mat[16];
...
void X_Axis_ViewWidget::bindData(vbo_t* vbo)
{
	int i;
...
void X_Axis_ViewWidget::drawData(vbo_t* const vbo, int mode)
{
	int i;
	float rotMat[16];
...
void X_Axis_ViewWidget::drawBbox(vbo_t* const vbo, int mode)
{
	int i;
...
void X_Axis_ViewWidget::gBufferRendering(void)
{
	glBindFramebuffer(GL_FRAMEBUFFER, gBuffer);
...
void X_Axis_ViewWidget::ssaoTextureRendering(void)
{
	glBindFramebuffer(GL_FRAMEBUFFER, ssaoFBO);
...
void X_Axis_ViewWidget::ssaoBlurRendering(void)
{
...
void X_Axis_ViewWidget::ssaoLightPassRendering(void)
{
...
void X_Axis_ViewWidget::shadowMappingRendering(void)
{
...
void X_Axis_ViewWidget::paintGL(void)
{
...
void X_Axis_ViewWidget::resizeSSAO(void)
{
	glBindFramebuffer(GL_FRAMEBUFFER, gBuffer);
	// - Position + linear depth color buffer
	glBindTexture(GL_TEXTURE_2D, gPositionDepth);
...
void X_Axis_ViewWidget::resizeGL(int width, int height)
{
	float mat[16];
...
void X_Axis_ViewWidget::mousePressEvent(QMouseEvent *e)
{
	int i, ret;
	unsigned int objID;
	float rayDir[3];
...
void X_Axis_ViewWidget::mouseReleaseEvent(QMouseEvent *e)
{

}

void X_Axis_ViewWidget::keyPressEvent(QKeyEvent *e)
{
	int key;
...
void X_Axis_ViewWidget::renderQuad()
{
	if (quadVAO == 0)
	{
...
/*
void X_Axis_ViewWidget::openVO(const char* fileName)
{
int i;
voxelobj_t* obj;
...
void X_Axis_ViewWidget::openVolume(const char* fileName)
{
