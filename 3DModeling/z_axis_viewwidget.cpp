...
Z_Axis_ViewWidget::Z_Axis_ViewWidget(QWidget * parent) : QOpenGLWidget(parent)
{
	setupOpenGL();
...
void Z_Axis_ViewWidget::genSSAO(void)
{
	// Set samplers
...
void Z_Axis_ViewWidget::genShadowMapping(void)
{
...
void Z_Axis_ViewWidget::genMultiSampling(void)
{
...
void Z_Axis_ViewWidget::setupOpenGL(void)
{
...
void Z_Axis_ViewWidget::initializeGL(void)
{
	float mat[16];
...
void Z_Axis_ViewWidget::configureShadowMapping(void)
{
...
void Z_Axis_ViewWidget::configureGBufferShader(void)
{

}

void Z_Axis_ViewWidget::renderScene(void)
{
	int i;
...
void Z_Axis_ViewWidget::renderBbox(void)
{
	int i;
...
void Z_Axis_ViewWidget::setViewingMatrix(void)
{
...
void Z_Axis_ViewWidget::setLighting(void)
{
	GLuint loc;
...
void Z_Axis_ViewWidget::setMaterial(vbo_t obj)
{
	GLuint loc;
...
void Z_Axis_ViewWidget::fixView(void)
{
	float temp;
...
void Z_Axis_ViewWidget::updateViewing(void)
{
	float mat[16];
...
void Z_Axis_ViewWidget::bindData(vbo_t* vbo)
{
	int i;
...
void Z_Axis_ViewWidget::drawData(vbo_t* const vbo, int mode)
{
	int i;
	float rotMat[16];
...
void Z_Axis_ViewWidget::drawBbox(vbo_t* const vbo, int mode)
{
	int i;
...
void Z_Axis_ViewWidget::gBufferRendering(void)
{
	glBindFramebuffer(GL_FRAMEBUFFER, gBuffer);
...
void Z_Axis_ViewWidget::ssaoTextureRendering(void)
{
	glBindFramebuffer(GL_FRAMEBUFFER, ssaoFBO);
...
void Z_Axis_ViewWidget::ssaoBlurRendering(void)
{
...
void Z_Axis_ViewWidget::ssaoLightPassRendering(void)
{
...
void Z_Axis_ViewWidget::shadowMappingRendering(void)
{
...
void Z_Axis_ViewWidget::paintGL(void)
{
...
void Z_Axis_ViewWidget::resizeSSAO(void)
{
	glBindFramebuffer(GL_FRAMEBUFFER, gBuffer);
	// - Position + linear depth color buffer
	glBindTexture(GL_TEXTURE_2D, gPositionDepth);
...
void Z_Axis_ViewWidget::resizeGL(int width, int height)
{
	float mat[16];
...
void Z_Axis_ViewWidget::mousePressEvent(QMouseEvent *e)
{
	int i, ret;
	unsigned int objID;
	float rayDir[3];
...
void Z_Axis_ViewWidget::mouseMoveEvent(QMouseEvent *e)
{
...
void Z_Axis_ViewWidget::mouseReleaseEvent(QMouseEvent *e)
{

}

void Z_Axis_ViewWidget::keyPressEvent(QKeyEvent *e)
{
	int key;
...
void Z_Axis_ViewWidget::wheelEvent(QWheelEvent *e)
{
...
void Z_Axis_ViewWidget::renderQuad()
{
	if (quadVAO == 0)
	{
...
/*
void Z_Axis_ViewWidget::openVO(const char* fileName)
{
int i;
voxelobj_t* obj;
...
void Z_Axis_ViewWidget::openVolume(const char* fileName)
{
